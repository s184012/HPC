...
LOOPS=(100000 100000 100000 100000 10000 10000 10000 10000 10000 1000 1000 1000 1000 1000 1000)
LOGEXT=$CC.dat
...
for index in ${!NPARTS[*]}; do 
  ./aos.${CC} ${LOOPS[$index]} ${NPARTS[$index]} | grep -v CPU >> aos.$LOGEXT
  ./soa.${CC} ${LOOPS[$index]} ${NPARTS[$index]} | grep -v CPU >> soa.$LOGEXT
done
